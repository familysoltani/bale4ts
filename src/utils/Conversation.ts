...
export class Conversation {
  ...
  public startsWith(sensitive: string[] | Sensitive): Tracer {
    this.startSensitive = Array.isArray(sensitive)
      ? new TextMessageSensitive(sensitive)
      : sensitive
  ...
  public cancelsWith(
    ...
    this.cancelSensitive = Array.isArray(sensitive)
      ? new TextMessageSensitive(sensitive)
      : sensitive
  ...
  public handleMessage(
    ...
    this.tracer.callbacks[session.currentState](
      message,
      session,
      responser,
      receivedMessage
  ...
  public isActive(peer: User): boolean {
    if (!this.sessions[peer.id]) return false
...
export class Session {
  ...
  public next(): void {
    ...
    if (this.currentState >= this.tracer.callbacksNum) this.reset()
  }
